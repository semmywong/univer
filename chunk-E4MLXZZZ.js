...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("./zh-CN-XPRHL2XF.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("./zh-TW-YZNZC5AV.js");
        break;
      case "zhHK" /* ZH_HK */:
        locales2 = await import("./zh-HK-23W2RZKS.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("./fr-FR-YHTMJREV.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("./ru-RU-LUMMF24D.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("./vi-VN-CZWAK43K.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("./ja-JP-PYKHMNIE.js");
        break;
      case "faIR" /* FA_IR */:
        locales2 = await import("./fa-IR-MRJV4WOF.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("./ko-KR-QWXKN7HX.js");
        break;
      case "esES" /* ES_ES */:
        locales2 = await import("./es-ES-MMQR3XH6.js");
        break;
      case "caES" /* CA_ES */:
        locales2 = await import("./ca-ES-Q5HZPGSL.js");
        break;
      case "skSK" /* SK_SK */:
        locales2 = await import("./sk-SK-BSNXTSUK.js");
        break;
      case "ptBR" /* PT_BR */:
        locales2 = await import("./pt-BR-O2K4LT6I.js");
        break;
      case "deDE" /* DE_DE */:
        locales2 = await import("./de-DE-ZBVBTJWE.js");
        break;
      case "itIT" /* IT_IT */:
        locales2 = await import("./it-IT-34GSV4NT.js");
        break;
      case "idID" /* ID_ID */:
        locales2 = await import("./id-ID-XIQW3IAG.js");
        break;
      case "plPL" /* PL_PL */:
        locales2 = await import("./pl-PL-NYCO4TAL.js");
        break;
      case "arSA" /* AR_SA */:
        locales2 = await import("./ar-SA-BMVJLIH3.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("./en-US-KPZ42IWO.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "ff33ab8";
        const gitBranch = "dev";
        const buildTime = "2026-06-03T08:19:55.591Z";
